...
sections:
  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ### Journal
        1. <div style="font-size: 0.8em">K. Katsumata, M. Kambara, D. Yashima, <u><strong>R. Korekata</strong></u>, K. Sugiura, "Mobile Manipulation Instructions Generation from Multiple Images with Automatic Metric Enhancement," <strong>IEEE RA-L</strong>, 2025, to appear. (<strong>IF: 5.2</strong>)</div>
